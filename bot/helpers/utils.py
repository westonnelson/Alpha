...
class Utils(object):
	...
	def shortcuts(raw, allowsShortcuts):
		...
		if allowsShortcuts:
			...
			elif raw in ["mex"]: raw = "p xbt, eth mex, xrp mex, bch mex"
			...
			elif raw in ["funding", "fun"]: raw = "p xbt fun, eth mex fun, xrp mex fun, bch mex fun"
			elif raw in ["oi", "ov"]: raw = "p xbt oi, eth mex oi, xrp mex oi, bch mex oi"
		...
		elif raw in ["oi bch", "oi bchusd", "ov bch", "ov bchusd"]: raw = "p bchusd oi"
